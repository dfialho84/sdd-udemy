 ...
 *
 * Rastreabilidade: T-70 · REQ-2 · NFR-9 · DT-8
 *
 * Casos cobertos:
 * (a) Renderizacao do formulario nao gera violacoes axe reportadas
 * (b) Campos nome, email, senha, confirmacao de senha, data de nascimento e foto de perfil
...
describe("UT-10: RegisterPage — acessibilidade WCAG 2.1 AA e campos do formulario", () => {
  ...
  it("(b) campos nome, email, senha, confirmacao de senha, data de nascimento e foto de perfil presentes com labels associados", () => {
    render(<RegisterPage />);
