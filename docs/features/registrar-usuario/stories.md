...
Eu quero preencher um formulário com meus dados pessoais para criar minha conta
Para que eu possa ter acesso à plataforma sem depender de intervenção administrativa

_Critérios de aceitação_:

- O sistema deve exibir o formulário de cadastro com os campos nome, email, senha, confirmação de senha, foto de perfil e data de nascimento
- O sistema deve permitir o envio do formulário somente quando todos os campos obrigatórios estiverem preenchidos
